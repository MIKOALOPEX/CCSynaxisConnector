...
public final class CCSynaxisSuperHubPlantPort implements GameThreadPlantPort {
    private final CCSynaxisSuperHubBlockEntity blockEntity;
    private final EndpointId endpointId;
    private final String deviceName;

    public CCSynaxisSuperHubPlantPort(CCSynaxisSuperHubBlockEntity blockEntity, EndpointId endpointId, String deviceName) {
    ...
    public ComponentTypeId componentType() {
        return CCSynaxisSuperHubComponent.ID;
    }
